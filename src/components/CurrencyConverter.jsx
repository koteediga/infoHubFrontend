...
export default function CurrencyConverter(){
  ...
  async function convert(e){
    ...
    try {
      const q = to ? `/api/currency?amount=${amount}&from=${from}&to=${to}` : `/api/currency?amount=${amount}&from=${from}`;
  ...
  return (
    <div className="card">
      <form onSubmit={convert}>
        ...
        <input value={to} onChange={e=>setTo(e.target.value)} placeholder="Target (optional)" style={{width:120}} />
